...
<!--second child-->
<nav class="navbar navbar-expand-lg navbar-dark bg-color4">
...
<div class="bg-color2">
  ...
  <p class="text-center" class="light-text"> Unforgettable Eevents,Effortlessly Managed </p>
</div>
...
<!--row end-->
  ...
  <!--column end-->
    ...
    <div class="col-md-2 bg-color4 p-0">
    <!--brands to be displayed-->
  <ul class="navbar-nav me-auto text-center">
    <li class="nav-item bg-color2">
...
<!--last child-->
<div class="bg-color2 p-3 text-center">
